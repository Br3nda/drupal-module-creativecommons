/* $Id: README.txt,v 1.1.2.1 2009/07/24 07:40:58 balleyne Exp $ */
...
information, including metadata, can optionally be embedded inside HTML as RDF.
...
NOTE: if you installed a 6.x-dev snapshot from early July (or before that),
you may have to uninstall the module in order to get the database schema updates
needed to run
...
Initial development done by Kevin Reynen (kreynen). Major rewrite for Drupal 6 
